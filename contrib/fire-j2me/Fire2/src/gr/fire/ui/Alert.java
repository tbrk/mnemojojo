...
public class Alert extends Container implements CommandListener
{
	...
	public Alert(String txt,Image icon, byte type, byte defaultSelection)
	{
		...
		setForegroundColor(FireScreen.getTheme().getIntProperty("alert.fg.color"));
		setBackgroundColor(FireScreen.getTheme().getIntProperty("alert.bg.color"));
		...
		try{
			...
			case TYPE_WARNING:
				...
				button.setForegroundColor(FireScreen.getTheme().getIntProperty("alert.button.fg.color"));
				button.setBackgroundColor(FireScreen.getTheme().getIntProperty("alert.button.bg.color"));
