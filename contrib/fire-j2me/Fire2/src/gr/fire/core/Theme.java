...
public class Theme
{
	...
	public Theme()
	{
		...
		themeProperties.put("alert.bg.color",new Integer(TRANSPARENT));
		themeProperties.put("alert.fg.color",black);
		themeProperties.put("alert.button.bg.color",black);
		themeProperties.put("alert.button.fg.color",white);

		themeProperties.put("button.bg.color",black);
		themeProperties.put("button.fg.color",white);
